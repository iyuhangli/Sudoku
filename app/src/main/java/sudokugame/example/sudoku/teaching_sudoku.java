...
public class teaching_sudoku extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int theme_id;
        int theme_mode=1;
        sudoku_data easy_database=new sudoku_data(teaching_sudoku.this,"easy.db",null,1);
        ...
        setContentView(R.layout.activity_teaching_sudoku);
        getSupportActionBar().hide();

        final ImageButton back_from_teaching = findViewById(R.id.teaching_back);
        back_from_teaching.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent to_home_from_teaching=new Intent(teaching_sudoku.this , home_page.class);
                startActivity(to_home_from_teaching);
            }
        });
                ...
                if (value_content[0] != null) {
                    ...
                    builder.setPositiveButton("Yes", new DialogInterface.OnClickListener()
                    {
                        ...
                        public void onClick(DialogInterface dialog, int which)
                        {
                            ...
                            Intent to_share_puzzle = new Intent(teaching_sudoku.this, sudoku_play_easy.class);
