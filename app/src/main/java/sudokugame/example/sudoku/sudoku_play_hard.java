...
public class sudoku_play_hard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int theme_id;
        int theme_mode=1;
        sudoku_data easy_database=new sudoku_data(sudoku_play_hard.this,"easy.db",null,1);
        ...
        setContentView(R.layout.activity_sudoku_play_hard);
        ...
        settings_play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                @SuppressLint("WrongConstant") Toast toast = Toast.makeText(sudoku_play_hard.this, "", 1000);
                LinearLayout layout = (LinearLayout) toast.getView();
                TextView str = (TextView) layout.getChildAt(0);
                str.setTextSize(30);
                str.setTextColor(R.color.white);
                toast.setGravity(Gravity.CENTER, 0, 0);
                ImageView imageView = new ImageView(sudoku_play_hard.this);
        ...
        pause_play.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                final pause_pop_window popupWindow = new pause_pop_window(sudoku_play_hard.this);
                ...
                popupWindow.setOnPathItemClickListener(new pause_pop_window.OnPathItemClickListener() {
                    ...
                    public void onItemClick(pause_pop_window.four_lists item) {
                        if(item.list_name.equals("Home")){
                            Intent to_index=new Intent(sudoku_play_hard.this , home_page.class);
                            ...
                            Intent to_help=new Intent(sudoku_play_hard.this,teaching_sudoku.class);
                        ...
                        else {Toast.makeText(sudoku_play_hard.this,"点击了--->"+item.list_name,Toast.LENGTH_LONG).show();}
                    }
                });
            }
        });
    ...
    public String get_share_data(){
        ...
        Cursor cursor=easy_db_for_share.rawQuery("SELECT * FROM hard_level ORDER BY id DESC LIMIT 1",null);
    ...
    public void save_data(){
        ...
        easy_db.execSQL("INSERT INTO backup_hard (all_sudoku, half_sudoku) VALUES (?,?)", new Object[]{all_puzzle, half_puzzle});
                ...
                if (value_content[0] != null) {
                    ...
                    builder.setPositiveButton("Yes", new DialogInterface.OnClickListener()
                    {
                        ...
                        public void onClick(DialogInterface dialog, int which)
                        {
                            ...
                            Intent to_share_puzzle = new Intent(sudoku_play_hard.this, sudoku_play_hard.class);
