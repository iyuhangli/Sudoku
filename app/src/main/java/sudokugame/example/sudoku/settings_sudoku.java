...
public class settings_sudoku extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sudoku_data easy_database=new sudoku_data(settings_sudoku.this,"easy.db",null,1);
        easy_db= easy_database.getWritableDatabase();
        ...
        final ImageButton back_in_setting=findViewById(R.id.setting_back);

        back_in_setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent backinsetting=new Intent(settings_sudoku.this , home_page.class);
                startActivity(backinsetting);
            }
        });
    }
                ...
                if (value_content[0] != null) {
                    ...
                    builder.setPositiveButton("Yes", new DialogInterface.OnClickListener()
                    {
                        ...
                        public void onClick(DialogInterface dialog, int which)
                        {
                            ...
                            Intent to_share_puzzle = new Intent(settings_sudoku.this, sudoku_play_easy.class);
